import { LoginForm } from "@/modules/dashboard/components/login-form"
...
export default function Login() {
	return (
		<main className="flex w-full flex-col bg-primary-950">
			<div className="relative flex h-screen w-full flex-col items-center justify-center gap-8 overflow-x-hidden">
				<div className="z-1 flex h-full w-full items-center justify-center">
					<div className="relative flex h-full w-full max-w-screen-2xl flex-col items-center justify-between px-8 py-16 md:px-16">
						<div className="flex h-full w-full flex-col justify-center gap-8 lg:max-w-md">
					...
					<div className="relative hidden h-full w-full overflow-hidden bg-primary-950 lg:flex">
						<Image
							src="/images/home/jumbo-1.png"
							alt=""
							objectFit="cover"
