...
function RegisterTicketCard({ ticket }: TicketCardProps) {
	return (
		<div className="z-1 flex w-full flex-col-reverse justify-between gap-6 rounded-2xl border border-neutral-700 bg-primary-950/50 px-8 py-8 backdrop-blur-2xl lg:flex-row lg:px-16 print:border-0 print:bg-neutral-100">
