...
export function DashboardTable() {
	...
	return (
		<div className="z-1 flex w-full flex-col-reverse justify-between gap-6 border-neutral-700 border-t bg-primary-950/50 px-8 py-8 backdrop-blur-2xl lg:flex-row 2xl:px-16">
			<div className="flex w-full flex-col gap-8">
